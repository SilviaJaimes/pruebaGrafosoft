            ...
            <div className="my-4 flex w-full gap-4">
              <div className="flex flex-col w-4/5">
                ...
                <Card imagen="https://fastidious-bookkeeping-services.odoo.com/web_editor/shape/theme_bookstore/s_image_text.svg?c1=o-color-1" color="#E9A763" titulo="Hola, Andrés! Tienes ideas sobre un nuevo libro?" colorTitulo="#FFF"
                  colorParrafo="#FFF" fontSize="20px" letterSpace="0.5px" parrafo="Vuelve tus libros tendencia mundial!" tamañoParrafo="17px" parrafo2="Quieres empezar a escribir una vez más?" infoBoton="Crear Borrador" colorBtn="#343A3F" fontBtn="15px" widthBtn="220px"/>
                ...
                <Card imagen="https://www.icfes.gov.co/documents/39286/47085/presaber11.svg/ad88b203-092b-b35d-6ea7-effdb0d15e19?version=1.0&t=1642288992967&imagePreview=1" color="#343A3F" titulo="Andrés, nos gusta tu contenido y queremos darte los siguientes tips:" colorTitulo="#FFF"
                  colorParrafo="#FFF" fontSize="20px" letterSpace="0.5px" parrafo="1. Lee los comentarios de tus lectores." tamañoParrafo="17px" parrafo2="2. Elije el género que quieres para tu público." parrafo3="3. Busca siempre a un editor de confianza!"/>
              </div>
              ...
              <div className="flex flex-col w-1/3">
                ...
                <div className="contenedorLateral">
                  <div className="btn" id="button-look" style={{ position: 'absolute', right: 12 }}>
                    <p className="look" >Ver Todo</p>
                  </div>
                  <strong><h2 className="tituloLateral">Lo último</h2></strong>
