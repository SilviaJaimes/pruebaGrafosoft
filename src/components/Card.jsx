function Card({ letterSpace, imagen, color, titulo, parrafo, infoBoton, colorTitulo, colorParrafo, colorBtn, parrafo3, fontBtn, widthBtn, fontSize, tamañoParrafo, parrafo2, widthImg }) {
    return (
        <div className="card card-image-cover flex flex-row max-w-full" style={{ backgroundColor: color, marginTop: '5%' }}>
